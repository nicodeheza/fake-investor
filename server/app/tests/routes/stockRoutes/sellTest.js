...
describe("/stock/sell route", function () {
    ...
    describe("request auth", function () {
        let stockId, liquid, historyId, amount = 20;
        let res;
        before(function (done) {
        ...
        it("fud must be updated correctly", function () {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        it("ownership must be updated correctly", function () {
            return __awaiter(this, void 0, void 0, function* () {
                const [dbData] = yield db_1.default.promise().execute(`
            SELECT quantity FROM Ownerships WHERE stock_id=4 AND user_id=1
            `);
                (0, chai_1.expect)(parseFloat(dbData[0].quantity)).to.equal(amount - reqBody.amount);
            });
        });
        it("history must be created correctly", function () {
            return __awaiter(this, void 0, void 0, function* () {
                const [dbData] = yield db_1.default.promise().execute(`
        ...
        it("transaction must be added correctly", function () {
            return __awaiter(this, void 0, void 0, function* () {
            ...
            `, [historyId]);
                ...
                (0, chai_1.expect)(transaction.buy).to.be.equal(0);
